...
public interface ClassTeacherRepository extends JpaRepository<ClassTeacher, Long> {
    ...
    Page<ClassTeacher> findByClazzIdAndStatusIn(Long classId, List<CommonStatus> statuses, Pageable pageable);

    List<ClassTeacher> findByClazzIdAndStatusIn(Long classId, List<CommonStatus> statuses);

    Optional<ClassTeacher> findByClazzIdAndUserId(Long classId, Long userId);

    boolean existsByClazz_IdAndUser_IdAndStatus(Long classId, Long userId, CommonStatus status);
    ...
    List<ClassTeacher> findByUserIdAndStatus(@Param("userId") Long userId, @Param("status") CommonStatus status);
...
""")
    List<Long> findUserIdsByClazzIdAndStatusIn(Long classId, Collection<CommonStatus> statuses);
}