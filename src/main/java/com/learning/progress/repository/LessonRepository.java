...
public interface LessonRepository extends JpaRepository<Lesson, Long> {
    ...
    @Query("SELECT l FROM Lesson l WHERE l.chapter.id = :chapterId AND l.deletedAt IS NULL ORDER BY l.orderNumber ASC")
    List<Lesson> findByChapterIdAndDeletedAtIsNullOrderByOrderNumberAsc(@Param("chapterId") Long chapterId);
}